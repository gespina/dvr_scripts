...
hole.StyledText = comp.BezierSpline()
hole.StyledText[0] = '1st'

par = comp.FindTool("Par")
par.StyledText = comp.BezierSpline()
par.StyledText[0] = 'Par 4'

yards = comp.FindTool("Yards")
yards.StyledText = comp.BezierSpline()
yards.StyledText[0] = '--Yds'

shot = comp.FindTool("Shot")
shot.StyledText = comp.BezierSpline()
shot.StyledText[0] = '1st Shot'

score = comp.FindTool("Score")
score.StyledText = comp.BezierSpline()
